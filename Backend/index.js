            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        query = "INSERT INTO ".concat(tableName, "(Name , Email, Password) VALUES ('").concat(userInfo.name, "', '").concat(userInfo.email, "', '").concat(userInfo.password, "')");
...
app.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                data = req.body;
                if (!(data.name && data.email && data.password)) return [3 /*break*/, 7];
                return [4 /*yield*/, obj.createTable("UsersData")];
            case 1:
                _a.sent();
                return [4 /*yield*/, pool.connect()
                    //Validating weather user exist or not
                ];
            case 2:
                _a.sent();
